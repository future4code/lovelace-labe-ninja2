    ...
    render() {
        return (
            <FiltroContainer>
                ...
                <label> Valor Mínimo:
                    <input type="number" 
                           onChange={this.props.onChangeValorMinimoFiltro} 
                           value={this.props.valorMinimoFiltro} 
                           placeholder="R$ 0.00"></input></label>

                <label>Valor Máximo:
                    <input type="number" 
                           onChange={this.props.onChangeValorMaximoFiltro} 
                           value={this.props.valorMaximoFiltro} 
                           placeholder="R$ 1000.00"></input></label>
